...
export const arrayOfProject = [
  {
    ...
    image: '/images/portfolio/Momentum.gif',
    tags: ['Local Storage','Javascript', 'HTML5', 'CSS3', ],
  ...
  },
  {
    ...
    description: "Realizing how much of a skill booster cloning practice is, I wanted to continue on cloning projects but needed a unique one that would make my work stand out. This clone is a mock-up of Window paint brush, made with MDN Canvas API. Main features are drawing, filling, erasing and reseting, all of which are interactive with the colors off of the buttons.",
    image: '/images/portfolio/Paintbrush.gif',
    tags: ['MDN Canvas','Javascript', 'HTML5', 'CSS3', ],
    link: 'https://google.com',
  ...
  },
  {
    ...
    image: '/images/portfolio/Calculator.gif',
    tags: ['ES6','Javascript', 'HTML5', 'CSS3', ],
    link: 'https://google.com',
